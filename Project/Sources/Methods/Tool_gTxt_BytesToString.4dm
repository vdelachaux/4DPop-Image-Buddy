...
C_TEXT:C284($Txt_Buffer; $Txt_Format; $Txt_IntegerFormat; $Txt_Nul; $Txt_RealFormat; $Txt_Requested_Unit; $Txt_Result; $Txt_Unit)
...
//LIRE FORMATAGE SYSTEME(0;$Txt_DecimalSeparator)
//LIRE FORMATAGE SYSTEME(1;$Txt_ThousandSeparator)
//$Txt_IntegerFormat:="###"+($Txt_ThousandSeparator+"###"*10)
//$Txt_RealFormat:=$Txt_IntegerFormat+$Txt_DecimalSeparator+"##"  `chiffres apres la virgule optionnels
...
If ($Lon_Precision=0)
	$Txt_Format:=$Txt_IntegerFormat
Else 
	$Txt_Format:=$Txt_RealFormat
End if 
